...
/**
 * Callback handler interface for mutual authentication command generation event
 */
public interface MutualAuthGenerateEvent {
    /**
     * Handles the success response with the response data
     *
     * @param response  Response from the cloud service
     */
    void onSuccess(MutualAuthGenerateResponse response);
